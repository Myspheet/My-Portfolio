...
const About = () => {
  ...
  return (
    <>
      <NextSeo
        title="About Me"
        description="A collection of projects I've built using Laravel, React, NestJS, and more."
        canonical="https://myspheet.vercel.app/about"
        openGraph={{
          url: "https://myspheet.vercel.app/about",
          title: "About | Promise Oghenevwefe",
          description:
            "Get to know about me, my skills, and experience as a Software Engineer.",
        }}
      />
        ...
        <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 xl:justify-start">
          <div className="flex-1 flex flex-col justify-center">
            ...
            >
              ...
              in 2017 while studying Computer Science. After earning my degree
              in 2018, I’ve continued to grow as a full-stack developer, working
              on everything from financial tools to eCommerce platforms. My core
              ...
              learning, always building. When I’m not coding, you’ll probably
              find me gaming, reading tech blogs or hanging out with friends and
              family.
            </motion.p>
            {/* countUp */}
            <motion.div
